...
* Again, we highlight that the minimum supported version of Node.js is now v18.12 (always use the LTS versions of Node.js - the higher the version the better).
